...
export default function Error({
  ...
  useEffect(() => {
    // No error-tracking service is wired up yet - this at least keeps the
    // failure visible in server/browser logs instead of vanishing silently.
  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center gap-6 bg-slate-950 px-6 text-center text-white">
      <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-red-500 to-orange-600">
